...
class Medication {
  ...
  factory Medication.fromJson(Map<String, dynamic> json, DateTime startDate) {
    ...
    int timesIndex = dosageIndex; // Assurez-vous que les temps correspondent à la dose
    if (timesIndex >= possibleTimes.length) {
      timesIndex = possibleTimes.length - 1; // Fallback si les listes ne sont pas parfaitement alignées
    }
